...
public class Person implements Comparable<Person> {  // class Name implements Comparable<Name> -> compareTo
    ...
    public static void main(String[] args) {
        ...
        // list = new Week12.Week11.StaticProgramAnalysis.Week10.GeneralProgramming.SortGeneric<Week12.Week11.StaticProgramAnalysis.Week10.GeneralProgramming.Person>().sortGeneric(list);
